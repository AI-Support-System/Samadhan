...
// Define the CustomerTicket interface
  ...
  useEffect(() => {
    const loadTickets = async () => {
      try {
        ...
        // Modified fetch function to handle CORS issues
        const response = await fetch(
          "https://script.google.com/macros/s/AKfycbw3AKjNC_DHGr248UWF-k4DAhg-8_VvPPRxDsrXBZE8YI72ouDR_SbxVFSXm52EVlr0/exec?action=get", 
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
            },
            // Adding mode to handle CORS
            mode: 'cors',
        ...
        setError('Failed to load customer tickets. Please check the console for details.');
