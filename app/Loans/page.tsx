...
className={`${activeTab === 'dashboard' ? 'text-indigo-400 border-b-2 border-indigo-400' : 'text-gray-300'} px-3 py-2 text-sm font-medium cursor-pointer whitespace-nowrap`}>
Dashboard
</button>
<button
onClick={() => setActiveTab('loans')}
className={`${activeTab === 'loans' ? 'text-indigo-400 border-b-2 border-indigo-400' : 'text-gray-300'} px-3 py-2 text-sm font-medium cursor-pointer whitespace-nowrap`}>
Loan Applications
</button>
<button
onClick={() => setActiveTab('credit')}
className={`${activeTab === 'credit' ? 'text-indigo-400 border-b-2 border-indigo-400' : 'text-gray-300'} px-3 py-2 text-sm font-medium cursor-pointer whitespace-nowrap`}>
Credit Health
</button>
<button
onClick={() => setActiveTab('tools')}
className={`${activeTab === 'tools' ? 'text-indigo-400 border-b-2 border-indigo-400' : 'text-gray-300'} px-3 py-2 text-sm font-medium cursor-pointer whitespace-nowrap`}>
Calculators & Tools
</button>
</nav>
</div>
...
<div id="creditScoreChart" style={{ height: '300px' }}></div>
</div>
</div>
{/* Loan Calculator */}
<div className="bg-gray-800 rounded-lg shadow mb-8">
...
className="mt-6 w-full bg-indigo-600 text-white px-4 py-2 rounded-button text-sm font-medium hover:bg-indigo-700 cursor-pointer whitespace-nowrap">
Apply Now
</button>
...
>
  <SwiperSlide className="!w-1/3 flex-shrink-0">
    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl text-white shadow-lg border border-gray-700 hover:shadow-2xl hover:border-indigo-500 hover:-translate-y-1 transition-all duration-300">
    <div className="flex items-center mb-4">
<i className="fas fa-home text-2xl text-purple-400 mr-3"></i>
<h4 className="text-xl font-semibold">Home Equity Line</h4>
</div>
...
<button className="w-full bg-purple-500 text-white px-6 py-3 rounded-button text-sm font-medium hover:bg-purple-600 transition-colors duration-200 cursor-pointer whitespace-nowrap flex items-center justify-center">
Learn More
<i className="fas fa-arrow-right ml-2"></i>
  ...
  <SwiperSlide className="!w-1/3 flex-shrink-0">
    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl text-white shadow-lg border border-gray-700 hover:shadow-2xl hover:border-purple-500 hover:-translate-y-1 transition-all duration-300">
    <div className="flex items-center mb-4">
<i className="fas fa-wallet text-2xl text-indigo-400 mr-3"></i>
<h4 className="text-xl font-semibold">Personal Loan</h4>
</div>
...
<button className="w-full bg-indigo-500 text-white px-6 py-3 rounded-button text-sm font-medium hover:bg-indigo-600 transition-colors duration-200 cursor-pointer whitespace-nowrap flex items-center justify-center">
Learn More
<i className="fas fa-arrow-right ml-2"></i>
</button>
    </div>
  ...
  <SwiperSlide className="!w-1/3 flex-shrink-0">
    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl text-white shadow-lg border border-gray-700 hover:shadow-2xl hover:border-rose-500 hover:-translate-y-1 transition-all duration-300">
    <div className="flex items-center mb-4">
<i className="fas fa-car text-2xl text-rose-400 mr-3"></i>
<h4 className="text-xl font-semibold">Auto Loan</h4>
</div>
...
<button className="w-full bg-rose-500 text-white px-6 py-3 rounded-button text-sm font-medium hover:bg-rose-600 transition-colors duration-200 cursor-pointer whitespace-nowrap flex items-center justify-center">
Learn More
<i className="fas fa-arrow-right ml-2"></i>
</button>
    </div>
