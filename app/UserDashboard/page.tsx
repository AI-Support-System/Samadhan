...
if (!mounted) {
  ...
  return (
    ...
    >
      {/* Background blur elements - keeping these for additional effect over the image */}
      <div className="absolute top-20 left-20 w-64 h-64 rounded-full bg-[#00F0FF]/20 blur-3xl"></div>
      <div className="absolute bottom-40 right-20 w-80 h-80 rounded-full bg-[#B026FF]/20 blur-3xl"></div>
      <div className="absolute top-1/3 right-1/4 w-72 h-72 rounded-full bg-[#FF2E6C]/10 blur-3xl"></div>
      
      <div className="max-w-[1440px] mx-auto relative z-10">
        {/* Header */}
        <header className="flex justify-between items-center mb-8 p-6 rounded-xl backdrop-blur-lg bg-white/5 border border-white/10 shadow-lg">
          <div className="flex items-center gap-4">
            <img
              src="logo.webp"
              alt="Logo"
              className="w-12.1 h-12 rounded-full"
            />
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="col-span-2">
            {/* Balance Row */}
            <div className="mb-8">
              <div className="backdrop-blur-xl bg-white/5 rounded-xl p-6 border border-white/10 shadow-lg mb-8 hover:bg-white/10 transition-all duration-300">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="backdrop-blur-xl bg-white/5 rounded-xl p-6 border border-white/10 shadow-lg hover:bg-white/10 transition-all duration-300">
            ...
            <div className="backdrop-blur-xl bg-white/5 rounded-xl p-6 border border-white/10 shadow-lg hover:bg-white/10 transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                ...
                <select
                  ...
                  className="bg-white/10 text-white border border-white/10 !rounded-button px-4 py-2 cursor-pointer backdrop-blur-sm"
                >
              ...
              <div className="space-y-4">
                {transactions.map(transaction => (
                  <div key={transaction.id} className="flex items-center justify-between p-4 rounded-lg hover:bg-white/10 transition-colors cursor-pointer backdrop-blur-sm border border-white/5">
                    <div className="flex items-center gap-4">
      ...
      <div className="fixed bottom-1 right-6 flex flex-col gap-6 z-50">
        ...
        <button 
          onClick={toggleChat}
          className="w-16 h-16 rounded-full bg-gradient-to-br from-[#00F0FF] to-[#00A8FF] flex items-center justify-center shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-[#80F8FF]/30 relative overflow-hidden group backdrop-blur-lg"
          style={{
        ...
        <button 
          ...
          className="w-16 h-16 rounded-full bg-gradient-to-br from-[#B026FF] to-[#D041FF] flex items-center justify-center shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-[#E366FF]/30 relative overflow-hidden group backdrop-blur-lg"
          style={{
            animation: "float 3s ease-in-out infinite",
            animationDelay: "0s"
          }}
